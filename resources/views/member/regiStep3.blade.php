            ...
            <div class="section-content">
                <table border="0" cellpadding="0" cellspacing="0" class="tbl-col-join">
                    ...
                    <tr>
                        ...
                        <td><input name="userName" type="text" class="input-text" style="width:302px"/></td>
                    </tr>
                    <tr>
                        <th scope="col"><span class="icons">*</span>아이디</th>
                        <td><input name="overChkid" type="text" class="input-text" style="width:302px" placeholder="영문자로 시작하는 4~15자의 영문소문자, 숫자"/>
{{--                            <a href="#" class="btn-s-tin ml10">중복확인</a>--}}
                    ...
                    <tr>
                        ...
                        <td><input name="password" type="password" class="input-text" style="width:302px" placeholder="8-15자의 영문자/숫자 혼합"/></td>
                    </tr>
                    <tr>
                        <th scope="col"><span class="icons">*</span>비밀번호 확인</th>
                        <td><input type="passwordConfirm" class="input-text" style="width:302px"/></td>
                    </tr>
                    <tr>
                        <th scope="col"><span class="icons">*</span>이메일주소</th>
                        <td>
                            <input name="email" type="text" class="input-text" style="width:138px"/> @ <input type="text" class="input-text" style="width:138px"/>
...
<script>
  ...
  function register(){
      ...
      const id = document.getElementsByName('overChkid')[0].value;

      $.ajax({
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          },
          data: {'mode': 'overChk', 'id': id },
          type:'POST',
          url: '/member/overChk',
  ...
  overChk.addEventListener('click',register);
</script>
@endsection
