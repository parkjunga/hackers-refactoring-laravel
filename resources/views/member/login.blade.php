@extends('layouts.header_css_script');
@section('body')
        ...
        <div class="box-login">
            <form action="/login" method="post" >
                ...
                <div class="input-text-box">
                    <input type="text" name="userId" class="input-text mb5" placeholder="아이디" style="width:190px"/>
                    <input type="password" name="password" class="input-text" placeholder="비밀번호" style="width:190px"/>
                </div>
